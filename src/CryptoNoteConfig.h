...
const uint64_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 1000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 1000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 10000000;
//TODO Currency-specific address prefix
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = CC;
...
const uint64_t MONEY_SUPPLY                                  = 63000000;
...
const uint64_t MINIMUM_FEE                                   = 0.00100000;
...
const char     CRYPTONOTE_NAME[]                             = "CoinForCoin";
...
const int      P2P_DEFAULT_PORT                              = 17994;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 49971;
